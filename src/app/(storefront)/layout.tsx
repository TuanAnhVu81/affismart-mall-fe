...
import { LazyChatbotWidget } from "@/components/ai/LazyChatbotWidget";
...
export const metadata: Metadata = buildPageMetadata({
  title: "Storefront",
  description:
    "Shop curated products on AffiSmart Mall with smart recommendations, affiliate tracking, and secure checkout.",
  path: "/",
});
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-4 lg:gap-16">
            <div className="space-y-4 md:col-span-1">
              <Button
                render={<Link href="/" />}
                aria-label="Go to AffiSmart Mall homepage"
                variant="ghost"
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-slate-600">
                ...
                <li><Link href="/products?sortBy=popular" className="transition-colors hover:text-slate-900">Featured Brands</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-slate-600">
                <li><Link href="mailto:support@affismart.mall?subject=Help%20Center" className="transition-colors hover:text-slate-900">Help Center</Link></li>
                <li><Link href="mailto:support@affismart.mall?subject=Shipping%20Details" className="transition-colors hover:text-slate-900">Shipping Details</Link></li>
                <li><Link href="mailto:support@affismart.mall?subject=Return%20Policy" className="transition-colors hover:text-slate-900">Return Policy</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                ...
                <button
                  ...
                  className="inline-flex h-10 w-full items-center justify-center rounded-xl bg-primary px-4 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90 sm:w-auto"
                >
                  Join
                </button>
              </div>
          ...
          <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-[#dbe3f0] pt-8 sm:flex-row text-sm text-slate-500">
            <p>&copy; {new Date().getFullYear()} AffiSmart Mall. All rights reserved.</p>
            <div className="flex gap-6">
              <Link href="mailto:support@affismart.mall?subject=Terms" className="hover:text-slate-900">Terms</Link>
              <Link href="mailto:support@affismart.mall?subject=Privacy" className="hover:text-slate-900">Privacy</Link>
              <Link href="mailto:support@affismart.mall?subject=Cookies" className="hover:text-slate-900">Cookies</Link>
            </div>
          </div>
        </div>
      </footer>
